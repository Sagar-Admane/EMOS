"""Deployment skill — answers questions about deployment and infrastructure."""
...
class DeploymentSkill(BaseSkill):
    """
    Answers deployment and infrastructure questions using
    graph data (services, databases) and SQL metadata.
    """
