"""Dependency skill — answers questions about code and service dependencies."""
...
class DependencySkill(BaseSkill):
    """
    Answers dependency questions using Neo4j graph data:
    imports, service relationships, database usages.
