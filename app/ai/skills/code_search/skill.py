"""Code Search skill — locates specific implementations and explains how they work."""
...
class CodeSearchSkill(BaseSkill):
    """
    Finds specific files, modules, or implementations in the codebase.
    Uses vector-searched code chunks to locate the exact place where
    features like databases or authentication are implemented.
    """
